...
//this one uses an explicitly defined pred function.
...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Explicit predicate: odd values first
        Func<int, bool> pred = x => x % 2 == 1;

        ListNode result = StablePartition(head, pred);
